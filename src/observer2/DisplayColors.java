...
public class DisplayColors implements ChangeListener, Subject{
    ...
    protected JPanel colorsPanel() {
        ...
        complementaryColorPanel = createComplimentaryColorPanel(Color.getHSBColor((float) .5, (float) .5, (float) .5));
        ...
        registerObserver((Observer)complementaryColorPanel);
        return p;
    }
...
//        slider.setValue(slider.getMinimum());
    ...
    protected ComplementaryColorPanel createComplimentaryColorPanel(Color initialColor) {
